...
class EventCreate(BaseModel):
    ...
    # Token buckets — int, non-negative, capped at 10M (well above any current context window)
    input_tokens: int | None = Field(None, ge=0, le=10_000_000)
    output_tokens: int | None = Field(None, ge=0, le=10_000_000)
    cache_read_tokens: int | None = Field(None, ge=0, le=10_000_000)
    cache_write_tokens: int | None = Field(None, ge=0, le=10_000_000)
    total_tokens: int | None = Field(None, ge=0, le=50_000_000)
    # Tools
